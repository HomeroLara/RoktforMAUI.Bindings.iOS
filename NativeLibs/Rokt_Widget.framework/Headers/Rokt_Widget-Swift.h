...
@interface RoktEmbeddedView : UIView <UIGestureRecognizerDelegate>
...
@interface RoktEmbeddedView (SWIFT_EXTENSION(Rokt_Widget)) <SFSafariViewControllerDelegate>
...
@interface RoktEmbeddedView (SWIFT_EXTENSION(Rokt_Widget)) <UITextViewDelegate>
...
@interface RoktEventHandler : NSObject
